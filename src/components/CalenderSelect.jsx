...
import { Card, CardBody, HStack, Text, Icon, VStack, Menu, MenuButton, MenuList, MenuItem, Button } from "@chakra-ui/react";
import { ChevronDownIcon } from "@chakra-ui/icons";

const CalendarSelect = () => {
  const [selectedOption, setSelectedOption] = useState("Upcoming Interviews");

  const options = ["Upcoming Interviews", "Scheduled Meetings", "Completed Interviews"];

  return (
    <Menu>
      <Card w="90%" borderRadius="10px" my={4} boxShadow="md" p={4} cursor="pointer">
