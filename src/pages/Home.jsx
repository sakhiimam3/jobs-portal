...
const Home = () => {
  return (
    <Box>
       <Box>
        <Box as="h1" fontSize="3xl"  fontWeight="bold" color="headingColor">Find your Dream Job, <Box as="span" color="bgbtn">Albert!</Box></Box>
          <Text color="link" fontSize="sm">
          Explore the latest job openings and apply for the best opportunities available today!        </Text>
       </Box>
